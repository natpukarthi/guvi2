...
<form action="signup-process.php" method="POST">
  <table class="table table-bordered">
    <tbody>
		...
		<td bgcolor="" class="alert alert-info" colspan="2"><b>REGISTER WITH US</b></td>
		</tr>
		<tr class="">
		<div class="form-group">
		...
		<td><input type="password" required name="password" minlength="6" class="form-control" id="password" onkeyup="return passwordChanged();">
		</td>
		</div>
		</tr>
		<tr class="">
		...
		<div class="form-group">
		<td align="right"></td>
		<td><input type="submit" onclick="myFunction()" name="submit" id="enter" class="btn btn-danger" value="Sign Me Up"/>
		<br><small>Already our customer ? <a href="login.php">Login Now</a></small></td>
		</div>
		</tr>
